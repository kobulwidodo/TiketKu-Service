...
func Init(cfg Config) *gorm.DB {
	...
	if err := db.AutoMigrate(&entity.User{}, &entity.Booking{}, &entity.BookingDetail{}, &entity.Event{}, &entity.Payment{}, &entity.Seat{}, &entity.Category{}, &entity.PaymentOption{}); err != nil {
		panic(err)
	}
